...
class NodeSpec:
    ...
    def to_node(
        ...
        Materialize a Node from a NodeSpec:
          ...
          - (optional) builds properties if your spec carries them
        """
        ...
        node = Base(
            ...
            parent=parent,
            metadata=metadata,
            spec=self,  # <-- only SpecNode accepts this
...
class _BaseHandle:
    ...
    def __call__(self, *args, **kwargs):
        ...
        node.set(prepare_function_inputs(self._spec.executor.executor, *args, **kwargs))
